    ...
    fn run(mut self) -> std::io::Result<()> {
        ...
        loop {
            match codegame::ServerMessage::read_from(&mut self.reader)? {
                codegame::ServerMessage::GetAction {
                    player_view,
                    debug_available,
                } => {
                    //let mut debug_interface = self.debug_interface();
                    let message = codegame::ClientMessage::ActionMessage {
                ...
                codegame::ServerMessage::Finish {} => break,
                codegame::ServerMessage::DebugUpdate { player_view } => {
